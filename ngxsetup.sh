...
# generate temp ssl 
openssl req -subj '/CN=see-me.co/O=VTWorld/C=IN' -new -newkey rsa:2048 -sha256 -days 365 -nodes -x509 -keyout /etc/ssl/private/apache-selfsigned.key -out /etc/ssl/certs/apache-selfsigned.crt
